...
if (r == true) {
  ...
  window.location.href = "ListDcReceipts2.php?s=4&id="+x+"&cy="+y;
...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title"><?php echo "Delivery Challan of Hindtex Industries"; ?></h5>
   ...
   <?php
    ...
    if($tag=="5")
    {
      ...
      $query = "SELECT *FROM ".$tablename." WHERE fd2=3";  
    }
    ...
    $page_first_result = ($page-1) * $results_per_page;
      ...
      $query = "SELECT *FROM ".$tablename." WHERE fd2=3 order by id DESC LIMIT "  . $page_first_result . ',' . $results_per_page;
    ...
    $no++;
              ...
              echo "<td>". $row["fd10"]. "</td>";
                         echo "<td>". $row["fd4"]. "</td>";
                            echo "<td><a href=View".$title.".php?id=". $row["fd1"]. "&cy=3&s=0&x=2&page=$page>View</a></td>";
            				 echo "<td><a href=Edit".$title.".php?id=". $row["fd1"]. "&page=$page&cy=3&s=3>Edit</a></td>";
					 echo "<td><a href=# onclick=\"deleteFormItem(".$row["fd1"].",3)\">Delete</a></td></tr>";
  ...
  //------------------------------------------------------------------
    ...
    for($page = 1; $page<= $number_of_page; $page++) {  
        echo '<a href = "ListDcReceipts2.php?page=' . $page . '">' . $page . ' </a>&nbsp;&nbsp;';  
    }
   echo "</p>";
   //------------------------------------------------------------------   
