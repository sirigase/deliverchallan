...
//$conn = new mysqli($servername, $username, $password, $dbname);
$sql = "INSERT INTO ".$tablename."(fd1,fd2,fd3,fd4,fd5,fd6,fd11,fd12)
VALUES ('$fd1','$fd2','$fd3','$fd4','$fd5','$fd6','$fd11','$fd12')";
        ...
        if($tag=="1")
    {
       ...
       ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                         <textarea class="form-control" name="fd2" id="fd2" placeholder="door no, street name, city, district, pincode, state" id="<?php echo $lb2; ?>"></textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" placeholder="Destination From" name="fd3" id="fd3"
                                              >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" name="fd11" id="<?php echo $lb11; ?>"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
