...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title"><?php echo "Products of Sashwat Shuttleless Looms"; ?></h5>
   ...
   <?php
    ...
    if($tag=="5")
    {
      ...
      $query = "SELECT *FROM ".$tablename." WHERE fd1=2";  
    }
    ...
    $page_first_result = ($page-1) * $results_per_page;
      ...
      $query = "SELECT *FROM ".$tablename." WHERE fd1=2 order by id DESC LIMIT "  . $page_first_result . ',' . $results_per_page;
    ...
    $no++;
                           ...
                           while($row = $result->fetch_assoc()) {
                             echo "<tr><td>". $no. "</td>";
                             echo "<td><a href=View".$title.".php?id=". $row["id"]. "&cy=2>". $row["fd2"]. "</a></td>";
							echo "<td>". $row["fd3"]. "</td>";
							 echo "<td>". $row["fd6"]. "</td>";
               if($row["fd1"]==2)
               {
                ...
                echo "<td>Hindtex</td>";
            				 ...
            				 echo "<td><a href=Edit".$title.".php?id=". $row["id"]. "&page=$page&cy=2>Edit</a></td>";
